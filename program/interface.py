...
class DownloadTranscriptPage(Screen):
    ...
    def GetTranscript(self):
        ...
        try:
            ...
            transcript_class.save_transcript_into_file('./transcript/{}.txt'.format(video_title), video_id, video_transcript)
        ...
        try:
            ...
            for video in videos:
                try:
                    ...
                    transcript_class.save_transcript_into_file(f'./transcript/{channel_name}/{video_title}.txt', video_id, transcripts)
                except: continue
...
class CompareFilesPage(Screen):
    ...
    def GetSelectedFile(self, SelectedFile):
        ...
        if len(SelectedFile) == 0: self.errorBlock.text = "You didn't choose the file"
        else:
